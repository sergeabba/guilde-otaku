...
export default function AdminMembresPage() {
        ...
        >
          ...
          <input
            ...
            style={{
              ...
              border: `1px solid ${pwError ? "#f87171" : "rgba(255,255,255,0.1)"}`,
              borderRadius: "10px",
              color: "#fff",
              fontFamily: "'Barlow Condensed', sans-serif",
              fontSize: "18px",
  ...
  const handleUpload = async () => {
    ...
    try {
      // Construire le nom de fichier cohérent avec members.ts
      const existingPath =
        photoType === "photo" ? member.photo : member.animeChar;
      const filename =
        existingPath.split("/").pop()?.replace(/\.[^.]+$/, "") ??
        member.name
          .toLowerCase()
          .replace(/[^a-z0-9]/g, "_")
          .replace(/_+/g, "_")
      ...
      <div style={{ maxWidth: "800px", margin: "0 auto" }}>
        ...
        <div style={{ ...cardStyle, marginBottom: "20px" }}>
          ...
          <select
            ...
            style={selectStyle}
          >
            <option value="" style={{ background: "#050508" }}>
            ...
            <div style={{ display: "flex", gap: "10px" }}>
              {(
                [
                  ...
                  {
                    value: "anime",
                    label: "Personnage anime",
                    icon: <Sword size={14} />,
                    current: member.animeChar,
                  },
                ] as const
              ).map((opt) => (
                <button
                  ...
                  style={{
                    ...
                    border: `1.5px solid ${photoType === opt.value
                      ? "#c9a84c"
          ...
          <div style={{ ...cardStyle, marginBottom: "20px" }}>
            ...
            {result && (
              ...
              >
                ...
                <div>
                  ...
                  {result.success && (
                    <p style={{ fontSize: "11px", color: "rgba(255,255,255,0.4)", marginTop: "4px", wordBreak: "break-all" }}>
                      {result.url}
                    </p>
                  )}
                  {result.success && (
            ...
            <button
              ...
              style={{
                ...
                padding: "15px",
                background:
                  !file || uploading ? "rgba(201,168,76,0.3)" : "#c9a84c",
                border: "none",
                borderRadius: "12px",
            ...
            >
              ...
              {uploading
                ? "Upload en cours..."
                : `Uploader comme ${photoType === "photo" ? "photo réelle" : "personnage anime"
                }`}
            </button>
          </div>
        )}
        ...
        >
          ...
          >
            <strong>Note :</strong> L'image est uploadée dans le bucket Supabase{" "}
            <code
              style={{
                background: "rgba(255,255,255,0.06)",
                padding: "1px 5px",
